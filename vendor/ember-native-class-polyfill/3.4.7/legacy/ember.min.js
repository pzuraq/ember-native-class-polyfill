...
o=i.pop()}}return[t,n,i,o=parseInt(o,10),r]}var _=0,E=0,w=0,R=0,C=0,O=0,A=0,T=0,k=0,S=0,P=0,x=0,N=0,M=0,L=0,I=0,D=0,j=0,F=0,B=0,U=0,z=function(){function e(e,t){var n=this
this.DEBUG=!1
...
this._platform=r(this._boundAutorunEnd)}e.prototype.begin=function(){E++
...
e.prototype.scheduleIterable=function(e,t){k++
...
e.prototype.scheduleOnce=function(e){P++
for(t=arguments.length,n=Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
var t,n,r,i=v.apply(void 0,n),o=i[0],s=i[1],a=i[2],u=this.DEBUG?new Error:void 0
return this._ensureInstance().schedule(e,o,s,a,!0,u)}
e.prototype.setTimeout=function(){x++
...
e.prototype.throttle=function(){M++
...
e.prototype.debounce=function(){L++
...
e.prototype.cancel=function(e){D++
...
e.prototype._scheduleAutorun=function(){j++
var e=this._platform.next
this._autorun=e()};(0,t.createClass)(e,[{key:"counters",get:function(){return{begin:E,end:w,events:{begin:R,end:0},autoruns:{created:j,completed:F},run:C,join:O,defer:A,schedule:T,scheduleIterable:k,deferOnce:S,scheduleOnce:P,setTimeout:x,later:N,throttle:M,debounce:L,cancelTimers:I,cancel:D,loops:{total:B,nested:U}}}},{key:"defaultQueue",get:function(){return this._defaultQueue}}])
return e}()
z.Queue=f
e.default=z
e.buildPlatform=i})
