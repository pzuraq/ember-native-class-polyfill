...
i.clear()
var l=qe.resume(u.env,r,r.reset(u.env)),c=mt.resume(t,u,l),p=new n.LinkedList
...
if(null!==r){if((t=r.openBlockDepth)>=r.startingBlockDepth)for(;n&&(!_t(n)||Et(n)!==t);)n=this.remove(n)
...
this.blockDepth--
var n=e.candidate
if(null!==n)if(_t(n)&&Et(n)===t){e.candidate=this.remove(n)
...
o=this.remove(n)
this.remove(r)
if(null!==o&&Ct(o)){this.candidate=this.remove(o)
...
if(n&&Rt(n)){t=(e=n).nextSibling
for(;t&&!Rt(t);)t=t.nextSibling
...
return i}if(i&&(function(e){return 8===e.nodeType&&"%|%"===e.nodeValue}(i)||Ct(i))){this.candidate=i.nextSibling
this.remove(i)
return this.__appendText(t)}if(Ct(i)){n=this.remove(i)
this.candidate=n
...
if(n&&wt(n)&&function(e,t){if(e.namespaceURI===re)return e.tagName===t
return e.tagName===t.toUpperCase()}(n,t)){this.unmatchedAttributes=[].slice.call(n.attributes)
return n}if(n){if(wt(n)&&"TBODY"===n.tagName){this.pushElement(n,null)
...
if(!o||!(i=Ot(o,t)))return e.prototype.__setAttribute.call(this,t,n,r)
i.value!==n&&(i.value=n)
o.splice(o.indexOf(i),1)}
r.prototype.__setProperty=function(t,n){var r,i=this.unmatchedAttributes
if(!i||!(r=Ot(i,t)))return e.prototype.__setProperty.call(this,t,n)
r.value!==n&&(r.value=n)
...
return t&&t[1]?Number(t[1]):null}function wt(e){return 1===e.nodeType}function Rt(e){return 8===e.nodeType&&"%glmr%"===e.nodeValue}function Ct(e){return 8===e.nodeType&&"% %"===e.nodeValue}function Ot(e,t){var n,r
